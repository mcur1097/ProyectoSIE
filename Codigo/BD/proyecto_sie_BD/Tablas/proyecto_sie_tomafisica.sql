...
--
-- Dumping data for table `tomafisica`
--

LOCK TABLES `tomafisica` WRITE;
/*!40000 ALTER TABLE `tomafisica` DISABLE KEYS */;
/*!40000 ALTER TABLE `tomafisica` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-04-01 18:48:19
